    ...
    <div className="h-full w-full overflow-y-auto p-4 md:p-8 bg-surface-bright">
      <div className="max-w-6xl mx-auto space-y-6 pb-12">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
          <div>
            <h1 className="text-2xl font-bold text-primary">Eksplorasi Intelijen Pasar</h1>
          ...
          <div className="flex items-center gap-3 w-full lg:w-auto">
            <div className="flex-1 lg:flex-none border border-outline-variant rounded-md bg-surface-container-lowest flex text-sm overflow-hidden divide-x divide-outline-variant shadow-sm">
              <div className="px-4 py-2 hover:bg-surface-container-low transition-colors cursor-pointer">
                <div className="text-[10px] font-bold text-on-surface-variant uppercase mb-0.5">KODE HS / KOMODITAS</div>
                <div className="font-semibold text-on-surface flex items-center gap-1">
                  <span className="material-symbols-outlined text-[14px]">barcode</span> 0901.11 - Kopi, belum dipanggang
                </div>
              </div>
              <div className="px-4 py-2 hover:bg-surface-container-low transition-colors cursor-pointer">
                <div className="text-[10px] font-bold text-on-surface-variant uppercase mb-0.5">WILAYAH SASARAN</div>
                <div className="font-semibold text-on-surface flex items-center gap-1">
                  Ringkasan Global <span className="material-symbols-outlined text-[16px]">expand_more</span>
                </div>
              </div>
            </div>
          ...
          <div className="bg-surface-container-lowest border-2 border-primary-fixed rounded-xl p-6 shadow-sm flex flex-col h-full">
            ...
            <div className="space-y-4 flex-1">
              ...
              <div className="border border-outline-variant rounded-lg p-4 bg-surface flex gap-3 hover:border-secondary transition-colors cursor-default">
                ...
                <div>
                  <h3 className="text-sm font-bold text-on-surface mb-1">Peluang Teridentifikasi</h3>
                  <p className="text-xs text-on-surface-variant leading-relaxed">Jerman menunjukkan toleransi harga premium tertinggi untuk biji kopi organik yang bersertifikat.</p>
                </div>
              </div>
              ...
              <div className="border border-error/30 rounded-lg p-4 bg-error-container/20 flex gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-on-surface-variant leading-relaxed">Bukti pemenuhan Regulasi Deforestasi Uni Eropa (EUDR) wajib disiapkan pada Kuartal 3 (Q3).</p>
                </div>
              </div>
            </div>

            <button className="w-full mt-6 bg-surface-container-lowest border border-primary text-primary font-semibold text-sm py-2.5 rounded-lg flex justify-center items-center gap-2 hover:bg-primary hover:text-on-primary transition-all shadow-sm">
